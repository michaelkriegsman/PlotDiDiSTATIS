...
Plot_DiSTATIS_F_Colored <- function(res_DiSTATIS, axes = c(1,2), Flip_axis1 = FALSE, Flip_axis2=FALSE, dev.new = TRUE){
  ...
  prettyPlot(res_DiSTATIS$res_DiSTATIS$eig$F[,axes] %*% Flip_mat,
             ...
             col = add.alpha(res_DiSTATIS$input$DESIGN_rows$colors_AB, .8),
             # col = add.alpha("black", .7),
             pch=15,
             main = paste0('DiSTATIS F_colored'))
